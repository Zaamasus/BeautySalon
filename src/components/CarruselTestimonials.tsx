  ...
  return (
    ...
    >
      ...
      <SwiperSlide className=''  >
        <div className=' hover:shadow-2xl h-[264px] w-[554px]  shadow-lg border-b-green-400 border-solid border-b-[5px]  rounded '>
        ...
        <div className='mb-[52px] flex items-center mt-8 ml-14' >
          <img className='rounded-full w-9 h-9 object-cover mr-2 mt'
          src="https://media.istockphoto.com/id/1386479313/pt/foto/happy-millennial-afro-american-business-woman-posing-isolated-on-white.jpg?s=1024x1024&w=is&k=20&c=8ZanqZPUGnq35YEyoEN9706LLYZYGf3JVu7BnsJ28hc=
          " 
          alt="" />
